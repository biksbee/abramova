...
//при такой маленькой выборке (17 транзакций разница между запросами незначительная,
//при работе с большей выборкой, более предпочтительнее и более минимизированный cost будет у подзапроса,
//так как CTE создает временное хранилище что дает излишнюю нагрузку)